...
{
    public class AnnualDepositWithOneYearService : IAnnualDeposit
    {
        private readonly AppDbContext _context;
        private int annualRepaymentPercentage=>20;
        public AnnualDepositWithOneYearService(AppDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<AnnualDeposit> requestAnnualDeposit(int customerId, int AnnualDepositValue)
        {
            ...
            newAnnualDeposit.AnnualDepositPeriod = 12;
            ...
            newAnnualDeposit.annualDepositType = AnnualDepositType.oneYear;
        ...
        {
            var annualDeposit = await _context.annualDeposits.Where(a => a.id == annualDepositId && a.annualDepositType == AnnualDepositType.oneYear).FirstOrDefaultAsync();
            ...
            {
                account.balance += (int)(annualDeposit.AnnualDepositRepaymentValue - annualDeposit.AnnualDepositValue)/12;
                annualDeposit.allowableCashingFromAnnualDeposit += (int)(annualDeposit.AnnualDepositRepaymentValue - annualDeposit.AnnualDepositValue) / 12;
                await _context.SaveChangesAsync();
